...
export const EnergyBudgetBar = memo(function EnergyBudgetBar({
  ...
  return (
    <>
    <div 
      className="card-simple-accent overflow-hidden p-0 cursor-pointer transition-opacity hover:opacity-90"
      ...
      aria-label="View energy budget details"
    >
    ...
    {expanded && (
      ...
      >
        ...
        <div 
          className="modal-card relative w-full max-w-md max-h-[90vh] overflow-y-auto"
          onClick={(e) => e.stopPropagation()}
        >
          <header className="modal-card-header">
            <h2 id="energy-modal-title" className="text-xl font-semibold text-[var(--text-primary)]">
