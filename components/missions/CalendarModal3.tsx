      ...
      {!loading && data && (
        <div className="space-y-5">
          ...
          <section>
            ...
            <p className="mt-0.5 text-xs text-[var(--text-muted)]">Totale geplande energy load en minuten; cap {ENERGY_CAP}/dag. Overload = rood. Afwijking = waarschuwing.</p>
          ...
          {data.strategy && (
            <section>
              ...
              <p className="mt-0.5 text-xs text-[var(--text-muted)]">Weekly allocation: primary = {domainLabel(data.strategy.primaryDomain)}.</p>
          ...
          <section>
            ...
            <p className="mt-0.5 text-xs text-[var(--text-muted)]">Optimaliseer mijn week op basis van energy pattern en druk.</p>
            <button
              type="button"
