  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-wrap items-end gap-4">
      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-neuro-muted">Goal name</span>
        <input
          type="text"
          value={name}
      ...
      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-neuro-muted">Target (e.g. 1000)</span>
        <input
          type="number"
          step="0.01"
          min="0"
      ...
      <label className="flex flex-col gap-1.5">
        <span className="text-sm font-medium text-neuro-muted">Deadline (optional)</span>
        <input
          type="date"
          value={deadline}
