...
export function LoadingScene({ title, subtitle, children }: LoadingSceneProps) {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[radial-gradient(circle_at_top,_#1b2140_0,_#050810_55%,_#02030a_100%)] text-[var(--text)]">
      ...
      >
        <div className="absolute -left-40 top-[-10%] h-80 w-80 rounded-full bg-[radial-gradient(circle,_rgba(var(--mode-rgb),0.16),_transparent_60%)] blur-3xl" />
        ...
        <div className="absolute bottom-[-20%] left-1/2 h-96 w-[120%] -translate-x-1/2 bg-[radial-gradient(circle_at_top,_rgba(var(--mode-rgb),0.22),_transparent_65%)] blur-3xl" />
      </div>
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-10">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
          ...
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-[var(--semantic-ring)]/45 bg-[var(--bg-elevated)]/90 px-4 py-2 text-xs text-[var(--text-soft)] shadow-[0_0_40px_rgba(var(--mode-rgb),0.35)]">
              <span className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[var(--semantic-accent)]/70" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-[var(--semantic-accent)]" />
              </span>
          ...
          <div className="glass-card relative overflow-hidden rounded-[26px] border border-white/6 bg-[color-mix(in_srgb,#050810_80%,#020617)] px-4 py-5 shadow-[0_18px_60px_rgba(0,0,0,0.85)] md:px-6 md:py-7">
            ...
            >
              <div className="absolute left-4 top-4 h-4 w-4 border-l border-t border-[var(--semantic-accent)]/60" />
              <div className="absolute right-4 top-4 h-4 w-4 border-r border-t border-[var(--semantic-ring)]/60" />
              <div className="absolute bottom-4 left-4 h-4 w-4 border-b border-l border-[var(--semantic-accent)]/50" />
              <div className="absolute bottom-4 right-4 h-4 w-4 border-b border-r border-[var(--semantic-ring)]/50" />
            </div>
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="mt-3 grid gap-3 md:grid-cols-3">
                      <div className="h-24 rounded-2xl bg-gradient-to-br from-[var(--semantic-accent)]/15 via-[var(--semantic-ring)]/5 to-transparent" />
                  ...
                  <div className="hidden flex-1 justify-end md:flex">
                    <div className="h-32 w-32 rounded-full border border-white/12 bg-[radial-gradient(circle_at_30%_20%,rgba(244,244,245,0.85),transparent_55%),radial-gradient(circle_at_70%_80%,rgba(var(--mode-rgb),0.55),transparent_55%)] shadow-[0_0_40px_rgba(var(--mode-rgb),0.45)]" />
                  </div>
                </div>
              )}
            </div>
