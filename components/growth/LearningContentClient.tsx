    ...
    <div className="space-y-6" data-tutorial="growth-content">
      ...
      <div id="growth-system" className="scroll-mt-28">
        <CollapsibleDashboardCard
          ...
          storageKey="growth-system-library"
          defaultExpanded={false}
          dataTutorial="growth-system-library"
        >
          <div className="space-y-6 px-4 pb-4 pt-0 md:px-5">
            <GrowthSystemLoop />
      ...
      >
        <div className="border-b border-[var(--card-border)] bg-[var(--bg-elevated)]/40 px-4 py-3">
          ...
          <p className="mt-1 text-sm text-[var(--text-secondary)]">
            Snelle links en optioneel het volledige statistiekoverzicht.
          </p>
        ...
        <CollapsibleDashboardCard
          ...
          subtitle={`${activeStreams}/${streamsCount} streams · ${sessionsThisWeek} sessies deze week · ${consistencyStatus} · L${level} · ${streak}d streak · ${mode === "war" ? "WAR" : mode === "recovery" ? "RECOVERY" : "FOCUS"}`}
          storageKey="growth-stats-grid"
          defaultExpanded={false}
          className="rounded-none border-0 border-t border-[var(--card-border)] bg-transparent shadow-none"
          dataTutorial="growth-stats-grid"
        >
          <div className="space-y-0">
            <div className="grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-4 md:px-5">
            ...
            <div className="border-t border-[var(--card-border)] px-4 py-4 md:px-5">
