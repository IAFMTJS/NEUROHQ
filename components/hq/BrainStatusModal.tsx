...
export function BrainStatusModal({ open, onClose, date, initial, yesterday }: Props) {
  ...
  }, [open, initial.energy, initial.focus, initial.sensory_load, initial.sleep_hours, initial.social_load]);
  ...
  return (
    <Modal
      ...
      subtitle="Energy, focus, and load drive your daily task capacity"
      size="lg"
    >
