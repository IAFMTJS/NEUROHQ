...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-1/2 z-50 w-full max-w-[min(960px,100vw)] -translate-x-1/2 border-t border-[var(--accent-neutral)] safe-area-pb backdrop-blur-[12px]"
      style={{
