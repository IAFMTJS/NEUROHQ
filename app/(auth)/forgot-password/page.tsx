        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <GlassCard className="w-full max-w-[360px] p-8 text-center rounded-2xl border border-[var(--card-border)]">
            ...
            <p className="mt-3 text-sm text-[var(--text-muted)] leading-relaxed">
              We sent a password reset link to <span className="font-medium text-[var(--text-primary)]">{email}</span>. Click it to set a new password, then sign in.
            </p>
    ...
    <main className="w-full max-w-[420px] hq-card-enter" style={{ animationDelay: "50ms" }} data-ui="dark-commander">
      <div className="flex flex-col items-center gap-6">
        ...
        <GlassCard className="w-full max-w-[360px] p-8 rounded-2xl border border-[var(--card-border)]">
          <h2 className="text-center text-sm font-semibold text-[var(--text-secondary)] mb-6">Reset your password</h2>
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="forgot-email" className="hq-label block mb-1.5">Email</label>
              <input
                id="forgot-email"
                type="email"
                autoComplete="email"
