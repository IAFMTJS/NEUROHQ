...
export default function TasksLoading() {
  return (
    <LoadingScene
      title="Missions board is loading"
      subtitle="Rebuilding today’s mission grid, rollover and avoidance tracker. You can already feel the structure while data streams in."
    >
